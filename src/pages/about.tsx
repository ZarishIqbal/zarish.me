...
const About = () => {
	return (
		<DefaultLayout meta={{ title: 'About Me' }}>
			<div className="p-10 space-y-3 mt-10 text-gray-600 flex justify-center flex-col bg-purple-50 m-5 rounded-2xl shadow-md border border-lightBlue-100 leading-7 text-left">
